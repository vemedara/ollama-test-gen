! function() {
    ...
    function t(t, e) {
        ...
        if (!(window._phantom || window.__nightmare || window.navigator.webdriver || window.Cypress)) {
            ...
            var i = {};
            i.n = t, i.u = a.href, i.d = o.getAttribute("data-domain"), i.r = r.referrer || null, i.w = window.innerWidth, e && e.meta && (i.m = JSON.stringify(e.meta)), e && e.props && (i.p = e.props);
    ...
    var w, d = window.history;
    d.pushState && (w = d.pushState, d.pushState = function() {
